...
class VliwConfigModalComponent extends React.Component<
  WithTranslation &
  ...
  render() {
    return (
      <Modal show={this.props.isVliwConfigModalOpen} onHide={this.close}>
        ...
        <Modal.Footer>
          <Button className="btn btn-primary" onClick={this.setDefault}>
            {this.props.t("vliwModal.default")}
          </Button>
          <Button onClick={this.cancel}>
            {this.props.t("commonButtons.close")}
          </Button>
          <Button className="btn btn-primary" onClick={this.saveVliwConfig}>
            {this.props.t("commonButtons.save")}
          </Button>
        </Modal.Footer>
      </Modal>
    );
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withTranslation()(VliwConfigModalComponent));
