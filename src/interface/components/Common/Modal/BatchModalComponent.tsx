...
class BatchModalComponent extends React.Component<any, any> {
	constructor(public props: any) {
		...
		this.handleCachePercentageChange =
			this.handleCachePercentageChange.bind(this);
		this.handleCacheFailLatencyChange =
			this.handleCacheFailLatencyChange.bind(this);
	}
...
export default connect(
	mapStateToProps,
	mapDispatchToProps,
)(withTranslation()(BatchModalComponent));
