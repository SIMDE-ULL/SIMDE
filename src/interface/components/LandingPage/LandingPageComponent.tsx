    ...
    <div className="page">
      <div className="topnav">
        <ul className="navul">
          ...
          <li>
            <Link to="/">{t("landingPage.home")}</Link>
          </li>
          <li>
            <Link to="/project">{t("landingPage.project")}</Link>
          </li>
        </ul>
      </div>
          ...
          <div className=" architecture col-3 col-sm-12 col-md-12 col-lg-12">
            <div className="jumbotron">
              <div className="container">
                ...
                <p>
                  <Link className="btn btn-primary btn-lg" to="/project">
                    {t("landingPage.read")}
                  </Link>
                </p>
              </div>
            ...
            <div className="thumbnail">
              <div className="caption">
                ...
                <div className="pagebtngroup">
                  <Link className="btn btn-primary" to="/superscalar">
                    {t("landingPage.go")}
                  </Link>
                  <a
                    className="pagebtn btn btn-light"
            ...
            <div className="thumbnail">
              <div className="caption">
                ...
                <div className="pagebtngroup">
                  <Link className="btn btn-primary" to="/vliw">
                    {t("landingPage.go")}
                  </Link>
                  <a
                    className="pagebtn btn btn-light"
