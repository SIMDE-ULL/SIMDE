    ...
    <div className="page">
      <div className="topnav">
        <ul className="navul">
          ...
          <li>
            <Link to="/">{t("landingPage.project")}</Link>
          </li>
        </ul>
      </div>
      <div className="pageproject">
        <h1>{t("projectPage.pagetitle")}</h1>
        <div className="simdegif">
          <img
            className="img-responsive"
            alt="SIMDE simulator demonstration"
        ...
        <Link to="/superscalar">
          <p>{t("projectPage.howtousedescription")}</p>
        </Link>
        <h2>{t("projectPage.problems")}</h2>
        <a href="https://etsiiull.gitbooks.io/simde/">
          <p>{t("projectPage.problemsdescription")}</p>
        </a>
      </div>
