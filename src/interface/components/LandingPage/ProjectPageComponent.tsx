      ...
      <div className="page">
        <div className="topnav">
         ...
         <div className="pageproject">
           ...
           <div className="simdegif"><img className="img-responsive" alt="SIMDE simulator demonstration" src="https://i.imgur.com/50m9kzv.gif"></img></div>
           ...
           <Link to="/superscalar"><p>{t('projectPage.howtousedescription')}</p></Link>
