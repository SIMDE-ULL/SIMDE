...
export const GeneralTabComponent: FC = () => {
  ...
  const jumpPrediction = useAppSelector((state) => state.Machine.jumpPrediction);
  ...
  const functionalUnitAluMem = useAppSelector((state) => state.Machine.functionalUnitAluMem);
  const reserveStationIntAdd = useAppSelector((state) => state.Machine.reserveStationIntAdd);
  const reserveStationIntSub = useAppSelector((state) => state.Machine.reserveStationIntSub);
  const reserveStationFloAdd = useAppSelector((state) => state.Machine.reserveStationFloAdd);
  const reserveStationFloSub = useAppSelector((state) => state.Machine.reserveStationFloSub);
  const reserveStationMemory = useAppSelector((state) => state.Machine.reserveStationMemory);
  const reserveStationJump = useAppSelector((state) => state.Machine.reserveStationJump);
      ...
      <div className="smd-general_tab-simulation">
        ...
        <div className="smd-general_tab-simulation_center">
          <div className="panel panel-default inside-bar panel--stack">
            ...
            <div className="panel-body">
              <ReserveStationComponent title="intAdd" data={reserveStationIntAdd} colors={colors} />
              <ReserveStationComponent title="intMult" data={reserveStationIntSub} colors={colors} />
              <ReserveStationComponent title="floatAdd" data={reserveStationFloAdd} colors={colors} />
              <ReserveStationComponent title="floatMult" data={reserveStationFloSub} colors={colors} />
              <ReserveStationComponent title="memory" data={reserveStationMemory} colors={colors} />
              <ReserveStationComponent title="jump" data={reserveStationJump} colors={colors} />
            </div>
          </div>
        </div>
        <div className="smd-general_tab-simulation_right">
          <div className="panel panel-default inside-bar panel--stack">
            ...
            <div className="panel-body">
              <FunctionalUnitComponent title="intAdd" header={functionalUnitIntAdd.header} content={functionalUnitIntAdd.content} colors={colors} />
              <FunctionalUnitComponent title="intMult" header={functionalUnitIntSub.header} content={functionalUnitIntSub.content} colors={colors} />
              <FunctionalUnitComponent title="floatAdd" header={functionalUnitFloAdd.header} content={functionalUnitFloAdd.content} colors={colors} />
              <FunctionalUnitComponent title="floatMult" header={functionalUnitFloSub.header} content={functionalUnitFloSub.content} colors={colors} />
              <FunctionalUnitComponent title="memory" header={functionalUnitMemory.header} content={functionalUnitMemory.content} colors={colors} />
              <FunctionalUnitComponent title="jump" header={functionalUnitJump.header} content={functionalUnitJump.content} colors={colors} />
              <FunctionalUnitComponent title="aluMem" header={functionalUnitAluMem.header} content={functionalUnitAluMem.content} colors={colors} />
            </div>
          </div>
        </div>
      </div>
